...
<img src="./assets/Xnip2024-12-19_16-50-17.jpg" style="zoom:55%;" />
...
<img src="./assets/1*eh48E1DUcz7uHusyRtIrhQ.png" style="zoom:90%;" />
...
<img src="./assets/pbjttotxrbkzo_3da39941f7b84175a370e2c497011d42.png" style="zoom:60%;" />
...
<img src="./assets/pbjttotxrbkzo_b03f716d013f49748c6652fce356cda7.png" style="zoom:75%;" />
...
<img src="./assets/Xnip2025-01-14_10-04-59.jpg" style="zoom:45%;" />
...
* `lambda: x[0]**2 + x[1]**2`其中`lambda`形成一个闭包，将`x`和函数绑定在一起。
* 输入`params`是一个`tensor`数组，表示对该参数计算梯度。
* `func`调用直接回更新`x`中的参数。
...
<img src="./assets/Saddle_point.png" style="zoom: 40%;" />
...
<img src="./assets/Iris-Dataset-Classification-20260619181923186.png" style="zoom:50%;" />
...
<img src="./assets/Xnip2025-06-04_20-59-38.jpg" style="zoom:65%;" />
...
例如：对于10000条训练数据，用大小为100条数据的mini-batch进行学习，重复随机梯度下降法100次，所有的训练数据就都被使用过了。此时，100次就是一个epoch。如果训练10个epoch，就是进行1000训练（iteration）。
