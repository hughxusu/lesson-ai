...
<img src="./assets/xor.jpg" style="zoom:40%;" />

感知机的局限性就在于它只能表示由一条直线分割的空间。如何想分割逻辑异或，只能使用如下曲线。

<img src="./assets/Xnip2024-12-12_15-43-48.jpg" style="zoom:40%;" />
...
<img src="./assets/Xnip2024-12-12_16-01-13.jpg" style="zoom:35%;" />
...
<img src="./assets/0ca2fd5a6590d22027e3058b497fdff1.jpeg" style="zoom:50%;" />

> [!note]
>
> 高维的张量和矩阵之间是可以相互转换的，而张量的计算是以矩阵的计算为基础。

高维张量间的计算，最后两个维度视为矩阵，其它维度视为循环。最后两维之前的任意维度`...`必须相等，如果不相等，这两个张量通常无法直接进行运算。
...
<img src="./assets/656a769280b04c.jpg" style="zoom:75%;" />
...
<img src="./assets/98602c4fbd104a9a91a9eba0b7099fb7.png" style="zoom:55%;" />
...
<img src="./assets/6206db46441e4f10b33bd752d7892b41.png" style="zoom:55%;" />
...
`flatten()`是复杂的结构拉成一条直线

* 参数表示保留的维度，只把后面的特征维度压平。
