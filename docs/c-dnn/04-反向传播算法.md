...
<img src="./assets/Xnip2025-01-16_10-28-19.jpg" style="zoom:35%;" />

如果将运算表示为节点，数值作为边，上述计算图表示为

<img src="./assets/Xnip2025-01-16_10-32-09.jpg" style="zoom:35%;" />

> [!think]
>
> 例2：小明在超市买了2个苹果、3个橘子。其中，苹果每个100元，橘子每个150元。消费税是10%，请计算支付金额。

<img src="./assets/Xnip2025-01-16_10-33-31.jpg" style="zoom:35%;" />
...
<img src="./assets/Xnip2025-01-16_10-34-13.jpg" style="zoom:35%;" />
...
<img src="./assets/Xnip2025-01-16_10-34-58.jpg" style="zoom:35%;" />
...
<img src="./assets/Xnip2025-01-16_11-31-19.jpg" style="zoom:35%;" />
...
<img src="./assets/5866a091069c00ee3ebd3b62e7bf772a.png" style="zoom:50%;" />
...
<img src="./assets/Xnip2025-01-16_13-41-15.jpg" style="zoom:35%;" />

其中$\frac{\partial L}{\partial z}$表示上游的计算结果。假设有计算$10+5=15$，反向传播上游计算的结果为$1.3$，则有

<img src="./assets/Xnip2025-01-16_13-47-52.jpg" style="zoom:35%;" />
...
<img src="./assets/Xnip2025-01-16_13-50-37.jpg" style="zoom:35%;" />

假设有计算$10\times5=50$，反向传播上游计算的结果为$1.3$，则有

<img src="./assets/Xnip2025-01-16_13-54-15.jpg" style="zoom:35%;" />

### 反向传播的实例

考虑例1中全部输入的反向传播

<img src="./assets/Xnip2025-01-16_13-59-47.jpg" style="zoom:35%;" />
...
<img src="./assets/Xnip2025-01-17_10-30-19.jpg" style="zoom:35%;" />

全连接层的反向传播计算为

<img src="./assets/Xnip2025-01-17_10-05-36.jpg" style="zoom:35%;" />
...
<img src="./assets/51c3298d5b3f85b7b51530b6fb30ef02.png" style="zoom:65%;" />
