...
![](./assets/2762311-20220321161940607-2135747316.png)
...
<img src="./assets/image-20201013161400022.png" style="zoom:50%;" />
...
<img src="./assets/image-20201013164341893.png" style="zoom:90%;" />
...
* 1999年David Lowe提出了尺度不变特征变换（SIFT, Scale-invariant feature transform）目标检测算法，用于匹配不同拍摄方向、纵深、光线等图片中的相同元素。
  ...
  <img src="./assets/image-20201013164647298.png" style="zoom:65%;" />
...
<img src="./assets/image-20201013165127393.png" style="zoom:50%;" />
