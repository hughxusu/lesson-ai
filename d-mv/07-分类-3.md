...
下面是一个基于Cifar-10数据训练Resnet的完成代码
...
<img src="../_images/mv/Xnip2025-02-14_16-25-37.jpg" style="zoom:65%;" />
...
7. 根据验证集调整参数后使用全部训练数据训练模型，测试集验证。
...
8.   0.8201000094413757  0.83079  0.8425  0.8489000201225281   0.8536
