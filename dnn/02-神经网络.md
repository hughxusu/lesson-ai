...
<img src="../_images/nn/Xnip2024-12-16_14-55-15.jpg" style="zoom:45%;" />
...
<img src="../_images/nn/Xnip2024-12-18_13-54-13.jpg" style="zoom: 40%;" />
...
<img src="../_images/nn/Xnip2024-12-19_08-46-17.jpg" style="zoom:40%;" />
...
<img src="../_images/nn/Xnip2024-12-19_09-53-35.jpg" style="zoom:40%;" />
...
<img src="../_images/nn/Xnip2024-12-19_10-00-24.jpg" style="zoom:40%;" />
...
<img src="../_images/nn/Xnip2024-12-19_10-08-38.jpg" style="zoom:40%;" />
...
<img src="../_images/nn/softmax-out.jpg" style="zoom:45%;" />

根据上面的softmax函数可得
$$
y_k=\frac{e^{a_k}}{\sum_{i=1}^{n}e^{a_i}}=\frac{e^c*e^{a_k}}{e^c*\sum_{i=1}^{n}e^{a_i}}=\frac{e^{a_k+c}}{\sum_{i=1}^{n}e^{a_i+c}}
$$
...
def load_mnist(normalize=True, flatten=True, one_hot_label=False):
    ...
    if one_hot_label:
        ...
        y_test = (y_test == np.arange(10)).astype(float)
