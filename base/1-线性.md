...
![](https://s11.ax1x.com/2024/03/01/pF0al9S.png)
...
计算求导公式
$$
\frac{\partial MSE_1}{\partial w} = \frac{1}{n}\sum_{i=1}^n 2(wx_i+b-\hat{y_i}) \cdot x_i
$$
当训练数据过多时，计算过程会非常耗时。为了降低计算量，会抽取部分训练集进行求导。$m \subseteq n$
$$
\frac{\partial MSE_2}{\partial w}= \frac{1}{m}\sum_{i=1}^m 2(wx_i+b-\hat{y_i}) \cdot x_i
$$
上面两个 MSE 的值只有在 $m=n$ 时重合，否则 $MSE_2$ 在 $MSE_1$ 周围波动。 其中 $m=16,64,128 ……

<img src="https://s11.ax1x.com/2024/03/01/pF0JJ29.jpg" style="zoom:53%;" />
...
<img src="https://s11.ax1x.com/2024/03/02/pF0xRXV.png" style="zoom:45%;" />
...
![](https://s11.ax1x.com/2024/03/02/pFB9sbV.png)
...
<img src="https://s11.ax1x.com/2024/03/02/pFBCLwV.jpg" style="zoom:50%;" />
