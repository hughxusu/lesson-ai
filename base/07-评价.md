...
$$
F1-Score本质描述的是准确率和召回率的调和平均值。F1-Score的特性是如果准确率和召回率不平衡，F1-Score的计算值会非常低。
...
<img src="../_images/base/p-r-1.jpg" style="zoom:55%;" />

2. 当$\text{threshold}>0$，时准确率和召回率的示意图

<img src="../_images/base/p-r-2.jpg" style="zoom:55%;" />

3. 当$\text{threshold}<0$，时准确率和召回率的示意图

<img src="../_images/base/p-r-3.jpg" style="zoom:55%;" />
...
<img src="../_images/base/1*KZu3UEBx3UIgOvdS6V_h_A.png" style="zoom:75%;" />
...
<img src="../_images/base/128711011f4a4e1249040612c72b62d4.jpg" style="zoom:50%;" />
...
为了让跟多的正样本被预测出来，需要降低阈值，但同时导致会有更多的负样本被预测为正样本，从而阐述错误。
...
<img src="../_images/base/pF5oo7R.png" style="zoom: 33%;" />

ROC曲线下面的面积称为AUC面积，面积越大分类性能越好。

<img src="https://raw.githubusercontent.com/hughxusu/lesson-ai/developing/_images/lo-re/1693297849223.png" style="zoom:70%;" />
