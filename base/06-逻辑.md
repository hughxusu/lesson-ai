...
<img src="../_images/base/c9c81130b42d0ec7a1d9d13771791494.jpg" style="zoom:48%;" />

所以$-\log(1-\hat{p})$的曲线为

<img src="../_images/base/661c9948cbf818ba028f89db922b50eb.jpg" style="zoom:55%;" />
...
<img src="../_images/base/1*4Ii3aorSLU50RV6V5xalzg.png" style="zoom:70%;" />

如果有$n$个类别进行$n$次分类，选择分类得分最高的。需要训练$n$个模型。

### OvO（One vs One）

<img src="../_images/base/1*oaszJq3fuH0me9UPAMyB6A.jpeg" style="zoom:50%;" />
