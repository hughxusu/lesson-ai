...
<img src="../_images/base/2020-09-09-WX20200909-225054@2x.png" style="zoom:60%;" />
...
$$
上述公式称为多元线性回归的正规方程解（Normal Equation），但是上述结果求解的时间复杂度为$O(n^3)$（优化后可达到$O(n^{2.4})$），实际应用中一般不使用正规方程解。
